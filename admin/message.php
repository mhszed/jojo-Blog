...
try {
    $stmt = $pdo->prepare("SELECT * FROM message WHERE content IS NOT NULL  ORDER BY create_time");
    $stmt->execute();
                    ...
                    <?php foreach ($use as $user) : ?>
                        <li class="user-item">
                            ...
                            <div class="user-name">
                                ...
                                <?php echo htmlspecialchars($user['nickname'] ?? '匿名'); ?>
                            </div>
                            <div class="user-email">
                                <?php echo $user['contact'] ? htmlspecialchars($user['contact']) : '未登记联络方式'; ?>
                            </div>
                            <div class="user-email">
                                <?php echo $user['content'] ? htmlspecialchars($user['content']) : '评论为空'; ?>
                            </div>

                            <div class="operate-col">
                                <form action="./delete_message.php" method="post" class="delete-form">
                                    <input type="hidden" name="message_id" value="<?php echo htmlspecialchars($user['id']); ?>">
